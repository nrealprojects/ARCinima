...
namespace Game {
    public class PlexusEffect : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            //this.transform.position = tubeGo.transform.position;
            ScaleAnimation();
        }
        ...
        private void ScaleAnimation()
        {
            ...
            //{
            this.GetComponent<Animator>().Play("PlexusParticleScale");
            particleSystem.startSize = particleSystem.shape.radius / 36f;
                data.maxDistance = particleSystem.shape.radius / 3.5f;
                data.width = data.maxDistance / 100f;
                //Debug.Log("okokokokok!   "+ particleSystem.shape.radius);
            //}
        }
